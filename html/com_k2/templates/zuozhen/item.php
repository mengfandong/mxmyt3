...
<?php echo $this->item->event->K2BeforeDisplay; ?>
		...
		<header>
			...
			<?php if($params->get('itemTitle')): ?>
				...
				<ul>
						...
						<li>
								<i class="fa fa-calendar"></i><span><?php echo JHTML::_('date', $this->item->modified, JText::_('Y-m-d')); ?></span>
						</li>
						<?php endif; ?>
		...
		<?php echo $this->item->event->BeforeDisplayContent; ?> <?php echo $this->item->event->K2BeforeDisplayContent; ?>
				...
				<div class="itemFullText kszuozhen"> <?php echo (!empty($this->item->fulltext)) ? $this->item->fulltext : $this->item->introtext; ?> </div>
				<?php endif; ?>
